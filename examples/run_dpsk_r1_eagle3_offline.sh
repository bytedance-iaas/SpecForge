...
# DeepSeek-R1 Eagle3 Training Script with Resume Support
...
echo "=== DeepSeek-R1 Eagle3 Training ==="
echo "GPUs: $NUM_GPUS"
...
CMD="torchrun \
    ...
    --target-model-path /root/models/DeepSeek-R1-0528 \
    --draft-model-config ./configs/deepseek-r1-eagle3.json \
    --train-data-path ./cache/dataset/train.jsonl \
    --train-hidden-states-path ./cache/hidden_states/ \
    --output-dir ./outputs/DeepSeek-R1-0528-eagle3 \
    --num-epochs 10 \
